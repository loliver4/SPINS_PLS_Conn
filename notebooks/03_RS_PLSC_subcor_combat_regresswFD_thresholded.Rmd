---
title: "02_RS_PLSC_subcor_combat_regress_thresholded"
...
```{r}
# read in ComBat connectivity data - wouldn't read this for some reason, but below generates the same thing 
#rs_combat_data <- read.csv("/projects/loliver/SPINS_PLS_Conn/data/processed/spins_rs_combat_data_01-10-2025.csv", header = T, row.names = 1)
...
# check if the first eigenvalue is significant 
...
cor.test(rs_plsc$TExPosition.Data$lx[,1],rs_plsc$TExPosition.Data$ly[,1]) 
